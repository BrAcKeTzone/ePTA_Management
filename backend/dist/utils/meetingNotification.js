 ...
 */
const sendMeetingNotification = async (recipientEmail, recipientName, meeting, customMessage) => {
 ...
 */
const sendMeetingReminder = async (recipientEmail, recipientName, meeting) => {
    const meetingDate = new Date(meeting.date).toLocaleDateString("en-US", {
        weekday: "long",
        year: "numeric",
        month: "long",
