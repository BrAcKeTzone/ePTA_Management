...
// Get all officers
export const getAllOfficers = asyncHandler(
  async (req: Request, res: Response) => {
    const officers = await officerService.getAllOfficers();

    return res
      .status(200)
      .json(new ApiResponse(200, officers, "Officers retrieved successfully"));
  }
);
...
export const removeOfficer = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, null, "Officer removed successfully"));
  }
);
